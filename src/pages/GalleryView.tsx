  ...
  return (
    <div className="min-h-screen bg-obsidian text-linen animate-fade-in">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        >
          <svg
            className="mx-auto mb-3 h-10 w-10 text-linen/40"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={1}
            ...
            {photos.map((photo, index) => (
              ...
              >
                <img
                  ...
                  alt=""
                  className="w-full rounded-xl object-cover transition-transform duration-700 ease-premium group-hover:scale-[1.02]"
                  loading="lazy"
                />
                <button
                  type="button"
